...
INSERT INTO budgets(userId, percentage, month) 
VALUES(1, 0.7, NOW());

INSERT INTO payments(categoryId, typeId, description, amount, date, budgetId)
VALUES(1,1,"first salary", 1000, NOW(), 1);

INSERT INTO payments(categoryId, typeId, description, amount, date, budgetId)
VALUES(4,1,"other", 500, NOW(), 1);


INSERT INTO payments(categoryId, typeId, description, amount, date, budgetId)
VALUES(5,2,"first salary", 200, NOW(), 1);
...
last_name, balance, percentage, month, description, amount, category, type
FROM users
